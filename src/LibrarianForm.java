...
public class LibrarianForm extends JFrame {
	...
	public LibrarianForm() {
		...
		JLabel lblAddLibrarian = new JLabel("Registration For Students");
		...
		JButton btnNewButton = new JButton(" Click To Submit");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			if(i>0){
				JOptionPane.showMessageDialog(LibrarianForm.this," Added Students details successfully!");
		...
		setTitle("Registration For Students ");
	}
